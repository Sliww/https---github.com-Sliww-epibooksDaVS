        ...
        <Container>
            <Row>
                <Col>
                    ...
                    <h4><strong>Epibooks</strong> was born from the idea that every book is a window into a new experience, a journey that can transform the way you see the world. Whether you're seeking immersive novels, enlightening essays, or short and powerful stories, you'll always find something here that resonates with your spirit.</h4>

                    <Row className="mt-5">

                        <Col sm={6} className="d-flex">
                            <h5>Our commitment goes beyond offering a wide variety of books. At <strong>Epibooks</strong>, we aim to create a community of curious and passionate readers. You’ll find not only virtual shelves filled with titles but also curated reviews, personalized reading recommendations, and a space to share your love for books.
                                ...
                                Thank you for choosing <strong>Epibooks</strong>. May your next great story begin here.
                                <strong>Happy reading!</strong></h5>
                        </Col>
